...
// 						echo "--------$keyC => $valueC----------";
			$restaurantes [$i] =html_entity_decode (preg_replace('/u([\da-fA-F]{4})/', '&#x\1;', trim ( $valueC)));
...
UpdateTable('cat_restaurantes', $arrayDatosInsertar,"id_restaurante");

	//EN EL CASO DE QUE ESTO SEA CORRECTO, DEBEMOS CREAR LA TABLA DEL RESTAURANT.


echo '{"success":true, "mensaje":"La modificación del restaurante fue exitosa"}';
?>
