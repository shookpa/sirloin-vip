...
$sql = "SELECT id, password, user,nombre, rol_user, a_paterno, a_materno,tipoUser FROM usuarios WHERE email='$arrPost[username]' AND ( password= PASSWORD('$arrPost[password]') OR password= OLD_PASSWORD('$arrPost[password]') )   AND status='1' ";
