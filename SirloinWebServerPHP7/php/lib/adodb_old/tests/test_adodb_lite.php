...
{
	$dsn = $_POST['databasetype'] . "://" . $_POST['dbusername'] . ":" . $_POST['dbpassword'] . "@" . $_POST['dbhost'] . "/" . $_POST['databasename'] . "#" . $_POST['transactions'] . $_POST['extend'] . $_POST['date'] . "pear";
...
{
	$db = ADONewConnection($_POST['databasetype'], $_POST['transactions'] . $_POST['extend'] . $_POST['date'] . "pear");
