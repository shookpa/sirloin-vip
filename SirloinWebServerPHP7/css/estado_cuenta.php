			...
			<div class="col-sm-12 cont-main-menu">
				<div class="row">
					<div id="Menu_section_personal_data" 
						class="col-sm-6 col-xs-12 item-1 cursor hvr-pop" style="height: 200px; ">
						
						<div class="boton-section" style="position:relative; height: 200px;">
							<div style="position:absolute;left:50%;bottom:15%;">
							<center>
								<h2 id="Menu_ImgPersonalData" class="text-uppercase linkAsSubmit"><b>Mi Perfil</b></h2>
							</center>
							</div>							
						</div>
					</div>
...
<!-- 							<center> -->
<!-- 								<h2 class="text-uppercase"><b>Mi Estado de Cuenta</b></h2> -->
<!-- 							</center> -->
<!-- 							</div> -->
<!-- 						</div> -->
<!-- 					</div> -->
