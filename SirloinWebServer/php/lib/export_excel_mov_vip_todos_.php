...
$sql = "SELECT 
		...
		LEFT JOIN clientes_vip ON clientes_vip.num_vip=mov_vip.num_vip
		";
...
// $objPHPExcel->setActiveSheetIndex ( 0 )->setCellValue ( 'A1', $nombreArchivo )->setCellValue
// ( 'A3', $titulosColumnas [0] )->setCellValue 
// ( 'B3', $titulosColumnas [1] )->setCellValue 
// ( 'C3', $titulosColumnas [2] )->setCellValue 
// ( 'D3', $titulosColumnas [3] )->setCellValue 
// ( 'E3', $titulosColumnas [4] )->setCellValue 
// ( 'F3', $titulosColumnas [5] )->setCellValue 
// ( 'G3', $titulosColumnas [6] )->setCellValue 
// ( 'H3', $titulosColumnas [7] )->setCellValue
// ( 'I3', $titulosColumnas [8] );
...
// 				$rsdDatos->fields ["id_mov"] )->setCellValue ( 'B' . $i, 
// 				$rsdDatos->fields ["nombre_restaurante"] )->setCellValue ( 'C' . $i, 
// 	utf8_encode ($rsdDatos->fields ["num_vip"] ) )->setCellValue ( 'D' . $i, 
// 				($rsdDatos->fields ["nom_vip"]) )->setCellValue ( 'E' . $i, 
// 				($rsdDatos->fields ["doc_vip"]) )->setCellValue ( 'F' . $i, 
// 				($rsdDatos->fields ["det_vip"]) )->setCellValue ( 'G' . $i, 
// 				($rsdDatos->fields ["fec_vip"]) )->setCellValue ( 'H' . $i, 
// 				($rsdDatos->fields ["mon_vip"]) )->setCellValue ( 'I' . $i, 
// 				($rsdDatos->fields ["caj_vip"]) );
// 	$i ++;
// 	$rsdDatos->MoveNext ();
// }
...
$objPHPExcel->getActiveSheet ()->setTitle ( 'Movimientos_Tarjetas_Clientes_VIP' );
